  ...
  return (
    <div>
      ...
      <Layout>
        ...
        <section
          id="beranda-dekstop"
          className="hidden lg:grid bg-white py-14 lg:py-0 mb:pb-6 grid-flow-col grid-cols-2 gap-4 row-span-4 h-screen"
        >
        ...
        <section
          id="resepsi"
          className="bg-white py-14  mb:pb-6 grid grid-flow-row gap-4 row-span-4 h-screen"
        >
        ...
        <section
          id="gallery"
          className="bg-white pt-8 md:pt-0 lg:pt-32 pb-24 lg:pb-8 grid grid-flow-row gap-4 grid-rows-7 lg:grid-rows-5 grid-cols-2 lg:grid-cols-3 h-screen px-4 lg:px-8"
        >
