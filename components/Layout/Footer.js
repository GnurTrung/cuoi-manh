...
const Footer = () => {
  return (
    <div className=" fixed lg:hidden bottom-0 mb-1 mx-1 right-0 left-0 z-20">
      <div className="bg-primary w-full px-6 rounded-full shadow border-opacity-20 border border-black">
        <ul className=" flex items-center justify-evenly text-black text-xs font-light py-2 md:py-3">
